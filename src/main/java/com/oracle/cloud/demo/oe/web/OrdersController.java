...
public class OrdersController implements Serializable {
    ...
    public void setSearchByCustomerEmail(String searchByCustomerEmail) {
        this.searchByCustomerEmail = searchByCustomerEmail;
        ejbFacade.setFilterByCustomerEmail(searchByCustomerEmail);
    }

    public String getSearchByCustomerEmail() {
        return searchByCustomerEmail;
    }
